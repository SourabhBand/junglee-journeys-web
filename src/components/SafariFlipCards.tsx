...
const experiences: {
...
}[] = [
  {
    ...
    href: '/safaris/',
    body: 'India is home to over a lakh species of fauna, which makes it one of the most biodiverse nations on the planet. With over 100 national parks spread across, the Indian wildlife list is huge. Ticking everything off may not be possible but we can try. Explore our safari destinations and contact us for safari packages.',
    icon: <PugmarkIcon />,
  ...
  },
  {
    ...
    body: 'All photographers have a dream frame; it may be an Osprey with a kill or just the perfect reflection of a Tiger drinking water. Luckily, we have had many photographers go home with a smile on their faces and that dream shot in the memory stick. We design target specific itineraries to give you the best chance of getting that dream shot!',
    icon: <ViewfinderIcon />,
    cta: 'Find your frame',
  },
  {
