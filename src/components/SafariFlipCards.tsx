...
const experiences: {
...
}[] = [
  {
    ...
    href: '/safaris/',
    body: 'India is one of the most biodiverse countries in the world, home to over a lakh species of fauna and more than 100 national parks. You may not see everything, but we can help you decide where to begin. Explore our safari destinations and let us build the right junglee journey for you.',
    icon: <PugmarkIcon />,
  ...
  },
  {
    ...
    body: 'Every wildlife photographer has a dream frame. It could be an Osprey with a catch or the perfect reflection of a tiger drinking water. We design target-specific itineraries to give you the best possible chance of capturing the shots you came for.',
    icon: <ViewfinderIcon />,
    cta: 'Find your frame',
  },
  {
    ...
    href: '/safaris/',
    body: 'With over 1,300 species of birds, India offers some of the finest birding in the world. From the Bengal Florican to the Great Indian Bustard, we create itineraries around your birding wish list and take you to the right places at the right time.',
    icon: <BinocularsIcon />,
  ...
  },
  {
    ...
    href: '/safaris/',
    body: "Why choose one destination when you can experience several? Spend seven to fourteen nights exploring India's finest wildlife parks through a bespoke itinerary designed around your interests. From the tigers of Central India to the birds of the Himalayas, build the journey that fits you.",
    icon: <RouteIcon />,
