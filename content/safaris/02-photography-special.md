# Page: Photography Special

| Field | Value |
|---|---|
| **URL** | `https://jungleejourneys.com/safari/photography-special/` |
| **Focus keyword** | wildlife photography tours india |
| **Meta title** (60 char) | Wildlife Photography Tours India \| Photo Safari \| Junglee Journeys |
| **Meta description** (149 char) | Capture stunning tiger images with expert-led photography safaris. Optimal lighting, pro naturalist guides and camera-friendly vehicles in Central India. |
| **H1** | Wildlife Photography Safari |
| **Search intent** | Commercial |
| **Content type** | Safari package detail |
| **Positioning angle** | Angle 3 (Continuity Mechanism) and Angle 5 (Sighting Specificity). The package's USP is guides who understand light and positioning at the level serious photographers need. High CPC ($5.98 US) indicates affluent serious-photographer audience. |
| **Bolded keywords** | wildlife photography tours india, tiger photography tour india, tiger photo safari, wildlife photography india, bird photography tours india, wildlife photography workshops india, wildlife photography safari, bird watching india, tiger photography workshop |
...
**[Plan Your Photography Trip](/enquire/)**
...
- Your own jeep with the photography seat configuration
- A photographer-naturalist who travels with you for the duration of the trip
- All game drives (typically two per day, with extended duration where the gate timings allow)
- All accommodation at the lodges we have selected for proximity to the gates
- All meals from arrival lunch to departure breakfast, including breakfasts served at productive locations inside the park rather than at standard rest stops
- All park fees, permits, and zone allocations (we book the most photography-productive zones in advance)
- All ground transfers between airports, parks, and lodges
- A pre-trip briefing with your photographer-naturalist about target species, expected conditions, and gear recommendations
- Our phone number for the duration of the trip

What is not included:

- International or domestic flights to and from the start airport
- Camera equipment, lens rental, or memory cards (we can recommend rental sources in Delhi or Mumbai if needed)
- Travel insurance
...
- **Serious enthusiasts** with a 300mm-plus lens, an understanding of exposure under challenging conditions, and a clear idea of what they want to come back with
- **Working photographers** on assignment, building a portfolio, or preparing for a publication or exhibition
- **Returning safari guests** who came back from a generic trip with photographs they were not happy with and want the next trip built around the camera
- **Couples or groups of two photographers** who want a private vehicle and want to optimise the trip for the camera rather than for general wildlife viewing
- **Workshop participants** looking for the kind of in-the-field tutoring that only happens when you spend a week with the same guide
...
| Item | Status |
|---|---|
| Focus keyword "wildlife photography tours india" in body (target 2-3) | ✓ About (1), Photography FAQs (1). Total: appropriate. |
| Focus keyword stuffing test | ✓ |
| Meta title 60 chars, includes focus keyword + brand | ✓ |
| Meta description 149 chars | ✓ |
| H1 "Wildlife Photography Safari" | ✓ |
| Secondary keywords present | ✓ tiger photography tour india (About), wildlife photography india (FAQs), wildlife photography workshops india (Variations + FAQs), wildlife photography safari (What Makes This Different), tiger photo safari (FAQs), bird photography tours india (Variations) |
| Tertiary keywords present | ✓ bird watching india (Variations), tiger photography workshop (Variations) |
| Internal links to /enquire/, destination pages | ✓ multiple |
| Em dashes | None |
