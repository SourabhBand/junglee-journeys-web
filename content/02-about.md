...
| **Positioning angle** | Angle 1 (DIY Permission Slip) primary; Angles 2 (Anti-Brochure) and 3 (Continuity) as supporting evidence |
| **Bolded keywords** | wildlife tours india, wildlife tour india, tiger conservation india, wildlife adventure india, nature tours india, wildlife experts india |
| **Note** | Trust-building page with light SEO. Founder name, team details, year of founding, NGO partner names, and rating badges are placeholders for the client to fill in. Marked in [brackets]. |

---

## Hero

# **About Junglee Journeys**
...
[Founder Name] saw their first tiger at [Park Name] in [Year]. They were [age]. The exact details (the time of day, the angle of the light, which direction the tigress was facing) are still on the tip of their tongue almost twenty years later, which tells you something about what that morning did to the rest of their life.
...
We have stayed at every lodge we recommend. Not as guests on a press trip. As people who chose the place because we wanted to. Some of them have outstanding food. Some have a single window that frames the forest in a way you remember years later. All of them let you exhale after a dusty game drive. We do not recommend lodges from a brochure, and the difference shows up on the third night.
...
[Client to provide team details. Format below for each person, with one human detail per bio that the brochure version would never include.]

### [Name], [Role]
[X] years in the field. Specialty: [tigers / leopards / birds / photography / something specific]. [One human detail. Something true that makes them sound like a person, not a CV. "Plays the harmonium badly." "Has a six-year-old who can identify forty species of bird by call." "Once spent three nights in a tree hide waiting for a sloth bear that never came." "Wrote a Wikipedia article about Kanha's gaur population that is still the best source on the topic."]

### [Name], [Role]
[X] years in the field. Specialty: [...]. [Human detail.]
...
The repeat rate is the one that matters most. People do not come back to a tiger safari if it was just fine. The first trip is the gamble. The second one is the verdict.

---

## Where Do You Want to Go?

Tell us what you are after. Dates, parks, whether you have done this before, what you would like the trip to feel like. We will write back with a quote within 24 hours, and the quote will be itemised so you can see exactly what you are paying for.

**[Start Your Journey](/enquire/)**   **[Explore Destinations](/destinations/)**   **[Browse Safaris](/safaris/)**
...
| Item | Status |
|---|---|
| Focus keyword "wildlife tours india" in body (target 3-4 across page) | ✓ Hero opening (1), conservation section (1), logistics section (1). Total: 3 occurrences spread across the page. |
| Focus keyword stuffing test | ✓ No 200-word block over 2 occurrences. |
| Meta title 55 chars, includes focus keyword + brand | ✓ |
| Meta description 147 chars | ✓ |
| H1 matches CSV | ✓ "About Junglee Journeys" |
| Secondary keywords present | ✓ wildlife tour india (Story close + Why This Works), tiger conservation india (conservation section), wildlife adventure india (planning section) |
| Tertiary keywords present | ✓ wildlife experts india (guides section), nature tours india (Why This Works) |
| Internal links to /destinations/, /enquire/, /safaris/ | ✓ all three present in CTA |
| Em dashes | None |
| Staccato fragment openers | None |
| Founder name, team names, NGO partners, ratings, year of first sighting | All marked as placeholders for client to fill in |
| Word count | ~880 |
