...
| **Positioning angle** | Angle 3 (Continuity Mechanism) primary; Angles 2 (Anti-Brochure) and 5 (Sighting Specificity) supporting |
| **Bolded keywords** | kanha safari, kanha national park, kanha tiger reserve, kanha tiger safari, kanha jungle safari, kanha safari booking, kanha resorts, kanha online booking, kanha tour package, mowgli kanha |
...
**[Plan Your Kanha Safari](/enquire/)**
...
- Leopards (often, especially in the buffer zones)
- Indian wild dogs (dhole), often hunting in packs
- Sloth bears (most likely in the rocky areas)
- Gaur, the Indian bison (the largest wild cattle on Earth)
...
| Day | Activities |
|---|---|
| **Day 1** | Arrive at Jabalpur airport mid-morning. Road transfer to your lodge in Kanha (about 4 hours, with a tea break en route). Lunch at the lodge. Afternoon game drive in Kanha or Mukki zone. Wildlife briefing with your naturalist over dinner. |
| **Day 2** | Pre-dawn coffee. Morning game drive (around 4 hours, full breakfast in the field). Lunch and a slow afternoon at the lodge. Second game drive starting around 3 PM. Dinner. |
| **Day 3** | Same rhythm. By the second day in the same zone, your guide will have a working theory about which tiger is where, and the day usually plays around that theory. |
...
- Layers for the cold mornings (it can be 5 degrees in December at 5:30 AM, warming to 25 by 11)
- A light fleece or jacket for the early afternoon as well in winter
- Comfortable walking shoes or trail runners (not hiking boots)
- A camera with a zoom lens (300mm is the minimum useful focal length; 400 to 600mm is better)
- Binoculars (genuinely useful for the bird species)
...
- **[Bandhavgarh National Park](/destination/bandhavgarh/)**. Kanha's natural pairing for a 7-night Central Indian trip. Higher tiger density, smaller park.
- **[Pench National Park](/destination/pench/)**. The third leg of the Central India Tiger Trail. Two hours from Nagpur, families welcome.
...
| Item | Status |
|---|---|
| Focus keyword "kanha safari" in body (target 4-6) | ✓ Hero (1 in CTA), About (1), Wildlife (1), CTAs (3 across page). Total: 5 occurrences spread across hero, body, and CTAs. |
| Focus keyword stuffing test | ✓ No 200-word block over 2 occurrences. |
| Meta title 58 chars, includes focus keyword + brand | ✓ |
| Meta description 153 chars | ✓ |
| H1 matches CSV | ✓ "Kanha Safari" |
| Secondary keywords present | ✓ kanha national park (About + Wildlife), kanha tiger reserve (Wildlife), kanha tiger safari (FAQ), kanha jungle safari (Safari Experience), kanha safari booking (Where to Stay), kanha resorts (Where to Stay) |
| Tertiary keywords present | ✓ kanha online booking (FAQ), kanha tour package (Ready section), mowgli kanha (About) |
| Internal links to /enquire/, /safari/central-india-tiger-trail/, /destinations/ | ✓ /enquire/ multiple, package linked, related destinations linked |
| H3 section consistency | ✓ "About Kanha", "Wildlife of Kanha", "Safari Experience at Kanha", "Best Time to Visit Kanha", "How to Reach Kanha", "Where to Stay in Kanha", "Sample Kanha Itinerary", "What to Pack for Kanha", "Kanha Safari FAQs", "Ready for Your Kanha Safari?" |
| Em dashes | None |
