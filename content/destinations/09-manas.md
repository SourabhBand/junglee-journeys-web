# Page: Manas National Park

| Field | Value |
|---|---|
| **URL** | `https://jungleejourneys.com/destination/manas/` |
| **Focus keyword** | manas safari |
| **Meta title** (52 char) | Manas Safari \| UNESCO Heritage \| Junglee Journeys |
| **Meta description** (149 char) | Book a Manas National Park safari. UNESCO World Heritage Site. Rare golden langur, pygmy hog. Remote Assam wilderness. Birding paradise. Nov to Apr season. |
| **H1** | Manas Safari |
| **Search intent** | Commercial |
| **Content type** | Destination detail (lowest volume of any park: 30 IN) |
| **Positioning angle** | Unique mechanism: UNESCO heritage, the truly remote one. Lean into off-the-map appeal. |
| **Bolded keywords** | manas safari, manas national park, manas national park safari |
...
**[Plan Your Manas Safari](/enquire/)**
...
**[Plan Your Manas Safari](/enquire/)**   **[WhatsApp Us](https://wa.me/919370037237)**

### Explore Other Parks

- **[Kaziranga National Park](/destination/kaziranga/)**. The natural pairing for Manas in a 5 to 7 night Northeast Indian trip. Two-thirds of the world's one-horned rhinos.
- **[Corbett National Park](/destination/corbett/)**. For guests who want to add a tiger reserve to a Northeast trip via Delhi.
...
| Item | Status |
|---|---|
| Focus keyword "manas safari" in body (target 3-4 for low-volume page) | ✓ Hero CTA (1), About (1), CTAs (3). Total: 5 occurrences. |
| Focus keyword stuffing test | ✓ |
| Meta title 52 chars, includes focus keyword + brand | ✓ |
| Meta description 149 chars | ✓ |
| H1 matches CSV | ✓ "Manas Safari" |
| Secondary keywords present | ✓ manas national park (About), manas national park safari (covered via "Manas National Park") |
| Internal links to /enquire/, /destinations/ | ✓ |
| H3 section consistency | ✓ |
| Em dashes | None |
| Word count | ~1,500 (lower-volume park, slightly tighter treatment) |
