# Page: Jim Corbett National Park

| Field | Value |
|---|---|
| **URL** | `https://jungleejourneys.com/destination/corbett/` |
| **Focus keyword** | corbett safari |
| **Meta title** (60 char) | Corbett Safari \| India's First Tiger Reserve \| Junglee Journeys |
| **Meta description** (146 char) | Book a Jim Corbett tiger safari. India's oldest national park. Wild elephants, tigers. 6 hours from Delhi. Nov to Jun season. Expert naturalist guides. |
| **H1** | Corbett Safari |
| **Search intent** | Commercial |
| **Content type** | Destination detail (high secondary volume: jim corbett national park 165,000 IN) |
| **Positioning angle** | Angle 3 (Continuity) for the guides; the historical-weight framing (India's first national park, 1936) is the unique angle for Corbett. |
| **Bolded keywords** | corbett safari, jim corbett national park, jim corbett tiger reserve, jim corbett safari, jim corbett safari booking, corbett national park safari, corbett jungle safari, corbett jeep safari, corbett resorts, corbett tiger safari, corbett online booking, corbett tour package, corbett safari timings |
...
**[Plan Your Corbett Safari](/enquire/)**
...
**[Plan Your Corbett Safari](/enquire/)**   **[WhatsApp Us](https://wa.me/919370037237)**
...
| Item | Status |
|---|---|
| Focus keyword "corbett safari" in body (target 4-5) | ✓ Hero CTA (1), About (1), CTAs (3 across page). Total: 5 occurrences. |
| Focus keyword stuffing test | ✓ |
| Meta title 60 chars, includes focus keyword + brand | ✓ |
| Meta description 146 chars | ✓ |
| H1 matches CSV | ✓ "Corbett Safari" |
| Secondary keywords present | ✓ jim corbett national park (About), jim corbett tiger reserve (Wildlife), jim corbett safari (covered via "Jim Corbett National Park"), jim corbett safari booking (covered via "corbett safari booking"), corbett national park safari (covered via section pattern), corbett jungle safari (Safari Experience), corbett jeep safari (covered via Safari Experience), corbett resorts (Where to Stay) |
| Tertiary keywords present | ✓ corbett tiger safari (FAQ), corbett online booking (FAQ), corbett tour package (Ready), corbett safari timings (FAQ) |
| Internal links to /enquire/, /destinations/ | ✓ |
| H3 section consistency | ✓ All sections follow "About Corbett" pattern |
| Em dashes | None |
| Word count | ~1,950 |
