# Page: Satpura National Park

| Field | Value |
|---|---|
| **URL** | `https://jungleejourneys.com/destination/satpura/` |
| **Focus keyword** | satpura safari |
| **Meta title** (60 char) | Satpura Safari \| Walking and Boat Safaris \| Junglee Journeys |
| **Meta description** (150 char) | Book a Satpura safari. India's only walking and boat safaris. Off-beaten gem. Rugged terrain, unique experiences. 150 km from Bhopal. Oct to Apr season. |
| **H1** | Satpura Safari |
| **Search intent** | Commercial |
| **Content type** | Destination detail (lower volume but unique-mechanism positioning) |
| **Positioning angle** | Angle 3 (Continuity) for guides; the unique-mechanism angle is the walking and boat safaris, which no other Indian park offers. The page leans into this hard. |
| **Bolded keywords** | satpura safari, satpura national park, satpura safari booking, satpura national park safari, satpura tiger safari, satpura resorts, satpura national park tour |
...
**[Plan Your Satpura Safari](/enquire/)**
...
| Item | Status |
|---|---|
| Focus keyword "satpura safari" in body (target 3-5 for lower-volume page) | ✓ Hero CTA (1), About (1), CTAs (3 across page). Total: 5 occurrences. |
| Focus keyword stuffing test | ✓ |
| Meta title 60 chars, includes focus keyword + brand | ✓ |
| Meta description 150 chars | ✓ |
| H1 matches CSV | ✓ "Satpura Safari" |
| Secondary keywords present | ✓ satpura national park (About), satpura tiger safari (Safari Experience), satpura resorts (Where to Stay), satpura safari booking (Where to Stay), satpura national park safari (covered via "Satpura National Park") |
| Tertiary keywords present | ✓ satpura national park tour (Ready) |
| Internal links to /enquire/, /destinations/ | ✓ |
| H3 section consistency | ✓ All sections follow "About Satpura" pattern |
| Em dashes | None |
| Word count | ~1,650 |
